...
//		 viewPager.setCurrentItem(1);
    ...
    public View getTabView(int position) {
        ...
        if (position == 0) {
            ...
            tabText_textView.setTextColor(ResourcesCompat.getColor(getResources()
                    , R.color.colorPrimary, null));
        } else {
...
//        if (((sMyFragment) fragment_list.get(1)).porterDuffViewImageView != null) {
//            if (!((sMyFragment) fragment_list.get(1)).porterDuffViewImageView.isHaveBitmap()) {
//                CommonUtil.showToast(sMainActivity.this,"fjd");
                updatePortrait();
//            }
//        }
