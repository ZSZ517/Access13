...
import com.example.access1.activity.sRecognizeTestActivity;
import com.example.access1.customview.PorterDuffViewImageView;
import com.example.access1.R;
import com.example.access1.bean.RotateBean;
import com.example.access1.adapter.RotateVpAdapter;
import com.example.access1.activity.sBrokenLogActivity;
import com.example.access1.activity.sChangePwdActivity;
import com.example.access1.activity.sFeedBackActivity;
import com.example.access1.activity.sInfoInputApply;
import com.example.access1.activity.sInformationInputActivity;

import java.util.ArrayList;
import java.util.List;

@SuppressLint({"NewApi", "ValidFragment"})
public class sMyFragment extends Fragment implements  OnClickListener {
    ...
    private PorterDuffViewImageView porterDuffViewImageView;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.mainPage_ll2_1_left:
                Intent intent1 = new Intent(getContext(), sRecognizeTestActivity.class);
    ...
    public void setPortrait(Bitmap bitmap) {
        ...
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                porterDuffViewImageView.setBitMap(sMyFragment.this.bitmap);
                porterDuffViewImageView.invalidate();
            }
        });
    }
